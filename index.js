try { require('dotenv').config(); } catch (e) { /* dotenv optional on hosts that inject env vars */ }
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://RyuuXiao:<db_xs-pedia>@cluster0.qptiic2.mongodb.net/?appName=Cluster0'; 
